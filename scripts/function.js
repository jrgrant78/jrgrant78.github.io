...
function scrollToServices(){ /*document.getElementById("services").scrollIntoView({ behavior: 'smooth', block: 'start' });*/ document.getElementById("services").scrollTo({ top:0, behavior: 'smooth' }) }
